        ...
        <div className="tspg-content">
          <div className="tspg-upside">
            ...
            <div className="tspg-status">
              <p>Status</p>
              <p>Documents &nbsp; 0/0 &nbsp;&nbsp; <FontAwesomeIcon icon={faCheckSquare} className="tspg-icon" /></p>
              <p>Labs &nbsp;  6/6 &nbsp;&nbsp; <FontAwesomeIcon icon={faCheckSquare} className="tspg-icon" /></p>
            </div>
          </div>
          {/* <hr /> */}
        </div>
      ...
      <div className="righttspg">
        <div className="tspg-contentt">
          ...
          <div className="tspg-footer">
            ...
            <button className="tspg-proceed-button">Proceed to Test</button>
          </div>
        </div>
      </div>
    </div>
